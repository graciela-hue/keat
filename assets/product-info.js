    ...
    class ProductInfo extends HTMLElement {
      ...
      handleUpdateProductInfo(productUrl) {
        return (html) => {
          ...
          updateSourceFromDestination('installments-price');
          updateSourceFromDestination('portions-blocks');
          updateSourceFromDestination('product_bundle');
      ...
      updateMedia(html, variantFeaturedMediaId) {
        if (variantFeaturedMediaId) {
            var $thumbSlide = $('.product__main-media-list .swiper-slide[data-image-id="' + variantFeaturedMediaId + '"]');
            if ($thumbSlide.length) {
                var index = $thumbSlide.index();
                window.product_main_thumb.slideTo(index),
                window.product_main_media.slideTo(index);
            }
        }
      }
